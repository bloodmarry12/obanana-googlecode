 ...
 *
 */
public class DataEntry2DeleteSQLFormatorTest extends AbstractBananaTester {

	@Test
	public void test_01(){
		DataEntry2DeleteSQLFormator formator = new DataEntry2DeleteSQLFormator();
		...
		Assert.assertEquals("delete from USER where ID = 1 and NAME = 'AOHAI.LI' and FK = SYSDATE ", sqls.get(0));
	}
}
