 ...
 * @author aohai.li
 */
public class SQLSelectDirective extends Directive {

	/**
	 * 
	 */
	private static final Logger log = Logger.getLogger(SQLSelectDirective.class);
	...
	public boolean render(InternalContextAdapter context, Writer writer, Node node)
		...
		if(!(blockNode instanceof ASTBlock)){
			throw new VelocityException("#SQL_select 异常，参数类型必须是ASTBlock");
		}
